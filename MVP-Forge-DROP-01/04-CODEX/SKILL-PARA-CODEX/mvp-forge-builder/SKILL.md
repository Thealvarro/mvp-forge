---
name: mvp-forge-builder
description: Define un MVP antes de programarlo, mediante una entrevista adaptativa que termina generando la documentación del proyecto en proyecto/. Úsala para ideas de SaaS, apps, webs, automatizaciones o productos digitales. Cubre problema, usuarios, alcance, funcionalidades, stack, arquitectura, base de datos y roadmap, priorizando herramientas gratuitas o free tier.
---
